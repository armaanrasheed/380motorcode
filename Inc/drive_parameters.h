...
#define MAX_APPLICATION_SPEED_RPM           9978 /*!< rpm, mechanical */
...
#define PID_TORQUE_KP_DEFAULT               3504
#define PID_TORQUE_KI_DEFAULT               2190
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 3504
...
#define PID_SPEED_KP_DEFAULT                2177/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define DEFAULT_TARGET_SPEED_RPM            3592
...
#define PHASE3_FINAL_SPEED_UNIT             (3991*SPEED_UNIT/U_RPM)
#define PHASE3_FINAL_CURRENT_A              6

/* Phase 4 */
#define PHASE4_DURATION                     0 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT             (3991*SPEED_UNIT/U_RPM)
#define PHASE4_FINAL_CURRENT_A              6

/* Phase 5 */
#define PHASE5_DURATION                     0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT             (3991*SPEED_UNIT/U_RPM)
